...
echo "FROM builder AS base" >> $DOCKERFILE
...
echo "FROM base AS minimal" >> $DOCKERFILE
...
echo "FROM minimal AS scipy" >>$DOCKERFILE
...
############################################################################
  " >>$DOCKERFILE
	...
	echo "FROM scipy AS datascience" >>$DOCKERFILE
...
############################################################################
  " >>$DOCKERFILE
	echo "FROM gpu AS useful" >>$DOCKERFILE
